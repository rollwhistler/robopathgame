...
/**
 * Api services for the `RoboUser` model.
 */
@Injectable()
export class RoboUserApi extends BaseLoopBackApi {
  ...
  /**
   * Queries accessTokens of RoboUser.
   *
   * @param {any} id RoboUser id
   *
   * @param {object} filter 
  ...
  /**
   * Counts accessTokens of RoboUser.
   *
   * @param {any} id RoboUser id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RoboUsers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.RoboUser#getCurrent
   * @methodOf sdk.RoboUser
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/RoboUsers" + "/:id";
   ...
   * call to {@link sdk.RoboUser#login} or
   * {@link sdk.RoboUser#getCurrent}. Return null when there
   ...
   * call to {@link sdk.RoboUser#login}
   *
  ...
  /**
   * @name sdk.RoboUser#isAuthenticated
   *
  ...
  /**
   * @name sdk.RoboUser#getCurrentId
   *
